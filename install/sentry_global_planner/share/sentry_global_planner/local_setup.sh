...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/src/sentry_sim/install/sentry_global_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sentry_global_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sentry_global_planner/environment/path.sh"
