    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(sentry_gazebo_share, 'launch', 'gazebo_rmuc.launch.py')
            ),
            launch_arguments={
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(vehicle_simulator_share, 'launch', 'system_rmuc.launch.py')
            ),
            launch_arguments={
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(far_planner_share, 'launch', 'far_planner.launch.py')
            )
        ),
    ])
